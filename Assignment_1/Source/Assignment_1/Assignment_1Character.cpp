...
void AAssignment_1Character::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("TurnRate", this, &AAssignment_1Character::TurnAtRate);
	InputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	InputComponent->BindAxis("LookUpRate", this, &AAssignment_1Character::LookUpAtRate);

	// handle touch devices
	InputComponent->BindTouch(IE_Pressed, this, &AAssignment_1Character::TouchStarted);
	InputComponent->BindTouch(IE_Released, this, &AAssignment_1Character::TouchStopped);
}
